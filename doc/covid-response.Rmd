...
Figure 2. Simulation based Bootstrap Distribution for the Null Hypothesis.
...
Our analysis can be built upon further to devise a more sophisticated framework to understand COVID-19 responses in Canada and USA. Some of the interesting points which would help expand the scope of this project include:
