...
estimate i.e a significance threshold level of \({\alpha = 0.05}\).

Our Null(\(H_0\)) and Alternate(\(H_a\)) Hypotheses are:

\[ \text {$H_0$: The median daily response ratio of Canada and USA between March 1st 2020 and October 31st 2020 is equal} \]

\[ \text {$H_a$: The median daily response ratio of Canada and USA between March 1st 2020 and October 31st 2020 is not equal} \]
...
[here](https://github.com/UBC-MDS/covid-19-cases-vs-tests-analysis/tree/main/src).
...
3.  Address the auto-correlation caused by the temporal nature of the
    ...
    techniques.
4.  Explore more features to include in quantifying the `Response
    Ratio`.
